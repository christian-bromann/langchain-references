 ...
 * AI Icons
 *
 * SVG icon components for AI-focused features like copy page,
 * context menu, and integrations with AI services.
 */
...
/**
 * Copy/Clipboard icon matching Mintlify style
 */
...
/**
 * MCP (Model Context Protocol) icon - chain/link style
 */
...
/**
 * File/Document icon for llms.txt
 */
