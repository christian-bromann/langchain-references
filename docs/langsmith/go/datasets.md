...
members: - New - Get - Update - List - Delete - Clone - GetCsv - GetJSONL - GetOpenAI - GetOpenAIFt - GetVersion - UpdateTags - Upload
...
options:
show_if_no_docstring: true
members: - List - GetCount - GetProgress - GetSummaries
...
options:
show_if_no_docstring: true
members: - New - Get - Update - List - Delete
